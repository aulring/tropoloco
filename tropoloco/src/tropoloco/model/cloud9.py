...
class EnvironmentEC2(BaseModel):
    ...
    ImageId_: str =  Field(description="""http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-cloud9-environmentec2.html#cfn-cloud9-environmentec2-imageid""", alias="ImageId")
